...
s1 = scatter( data(1:NperGroup,1), data(1:NperGroup,2),[],[244 225 129]/255,'filled'); 
hold on
s2 = scatter( data(NperGroup+1:end,1), data(NperGroup+1:end,2), [],[223 159 207]/255,'filled');
